...
class _FinanceAnalyticsPageState extends State<FinanceAnalyticsPage> {
  ...
  Future<void> _load() async {
    ...
    try {
      final rows = await _repo.listTransactions(
  ...
  double _total(String type) => _items
  ...
  List<Widget> _categoryRows() {
    ...
    if (entries.isEmpty) {
      return const <Widget>[Text('No expense categories recorded yet.')];
    }
          ...
          children: [
            ...
            SegmentedButton<int>(
              segments: const [
                ...
                ButtonSegment<int>(value: 365, label: Text('1y')),
              ],
              selected: <int>{_days},
                        ...
                        : BarChart(
                            BarChartData(
                              ...
                              barGroups: List.generate(months.length, (index) {
                                ...
                                final incomeMonth = monthItems
                                    .where((item) => item.type == 'income')
                                    .fold(0.0, (sum, item) => sum + item.amount);
                                final expenseMonth = monthItems
                                ...
                                return BarChartGroupData(
                                  ...
                                  barsSpace: 4,
                                  barRods: [
                                    BarChartRodData(toY: incomeMonth, width: 9),
                                    BarChartRodData(toY: expenseMonth, width: 9),
                                  ],
                                );
                              }),
                            ),
                ...
                Expanded(
                  child: Card(
                    child: ListTile(
                      ...
                      subtitle: Text(_money.format(income)),
                ...
                Expanded(
                  child: Card(
                    child: ListTile(
                      ...
                      subtitle: Text(_money.format(expense)),
            ...
            const Text(
              'Analytics are calculated from your recorded ledger entries.',
            ),
          ],
        ),
      ),
  ...
  double _chartMaxY(Map<String, List<FinanceTransaction>> grouped) {
    var maxValue = 1.0;
